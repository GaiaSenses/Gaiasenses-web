# GaiaSenses Web — guia de passagem (arquivado)

> **Arquivado.** Este era o `README.md` do projeto até agosto de 2026, escrito
> como guia de passagem para o próximo desenvolvedor. O `README.md` atual cobre
> tudo o que está aqui e mais — variáveis de ambiente, fluxo de dados,
> diagnóstico e dívida técnica. Fica preservado porque a ordem em que ele
> explica as coisas ainda é útil para quem está chegando, mas **onde os dois
> divergirem, o README.md vale.**
